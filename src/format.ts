export function parseKeys(data: { [index: string]: any }): FormatKeys {
  return Object.keys(data).reduce<FormatKeys>((keys, key) => {
...
export type FormatKeyContextItem = {
  value: FormatKeyValue;
  matches: FormatKeyContextMatches;
};
export type FormatKeyContextMatches = {
...
export function isValidValue(value?: FormatKeyValue) {
  return (
